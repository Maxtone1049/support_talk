...
class DropDownValueModel {
  final String name;
  final String? amount, variationCode, cryptoAddress, sellingRate, nameAlone;
  final dynamic value;
...
class KeyboardVisibilityBuilder extends StatefulWidget {
  ...
  const KeyboardVisibilityBuilder({Key? key, required this.builder})
    : super(key: key);
  @override
