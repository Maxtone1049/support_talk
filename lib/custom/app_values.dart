...
const String defaultErrorText = 'An error occured. Please try again';
const String noConnectionText =
    'Sorry, we have some trouble connecting. Check your internet connection and try again.';
...
final kDateFormatMMMdhmma = DateFormat('MMM d, h:mm a');
final kDateFormatEdMhmma = DateFormat("EE d MMM, h:mm a");
final kDateFormatMMMEE = DateFormat("MMM yyyy");
final kDateFormatJM = DateFormat('jm');

final RegExp urlCleanerRegex = RegExp(r'^(?:https?:\/\/)?(?:www\.)?([^\/\s]+)');
final RegExp emailRegex = RegExp(r"^[a-zA-Z0-9.]+@[a-zA-Z0-9]+\.[a-zA-Z]+");
final RegExp uppercaseRegex = RegExp(r'[A-Z]');
final RegExp specialCharacterRegex = RegExp(
  r'[!@#\$%^&*()_+\-=\[\]{};:"\\|,.<>\/?`~]',
);

const String longText = 'abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ';

const String placesAPIKey = 'AIzaSyDqiRy2YUlRIKWyKr8jdmfiFhHS-F4O7vE';

List<String> levels = ['Beginner', 'Junior', 'Intermediate', 'Professional'];
...
List<Map<String, dynamic>> categoriesJSON = [
    ...
    "services": [
      {
        ...
        "skills": [
          ...
          "Drain/Leaks fixing",
          "Pumping machine installation and repair",
          "Toilet repair",
          "Borehole drilling",
          "Water treatment and tank washing",
        ],
        "category": "Plumbing",
      },
    ],
    ...
    "services": [
      {
        ...
        "skills": [
          ...
          "Electrical repairs",
          "Fixtures/Fittings/Outlets",
          "Inverter repair/Installation",
          "Solar Installation",
          "Prepaid meter install",
        ],
    ...
    "services": [
      {
        ...
        "skills": [
          "Windows and Doors",
          "Cabinet installation and fixing",
          "Furniture",
          "Roofing",
        ],
    ...
    "services": [
      {
        ...
        "skills": [
          "Gas/Electric cooker",
          "TV installation, mounting and repair",
          "Microwave repair",
          "Home theatre",
          "Washing machine",
        ],
  ...
  },
  {
    ...
    "services": [
      {
        "name": "Laundry, Cleaning and Housekeeping",
        "skills": [
  ...
  },
  {
    ...
    "services": [
      {
        "name": "Barber",
        "skills": ["Haircut", "Hair dyeing/coloring"],
      ...
      },
      {
        ...
        "skills": ["Pedicure", "Manicure", "Acrylic nails", "Home service"],
        "category": "Beauty and Personal Care",
      },
      {
  ...
  },
  {
    ...
    "services": [
      {
        "name": "Generator repair and servicing",
        "skills": [
          "Diesel gen servicing",
          "Gasoline gen repair",
          "Diesel gen repair",
          "Gasoline gen servicing",
        ],
  ...
  {
    "name": "Logistics/Haulage Services",
    "services": [
      {
        "name": "Driver",
        "skills": [
          "Heavy machinery driver (trailer, tractor, etc)",
          "One off driving service",
          "Interstate driving service",
        ],
        "category": "Logistics/Haulage Services",
      },
      {
        "name": "Bike courier/Delivery services",
        "skills": ["Motorcycle", "Bike"],
        "category": "Logistics/Haulage Services",
      },
      {
        "name": "Moving services (haulage)",
  ...
  },
  {
    ...
    "services": [
      {
        "name": "Personal chef",
        "skills": ["Local dishes", "Intercontinental dishes"],
        "category": "Culinary/Event Services",
      },
      {
        "name": "Caterer",
        "skills": [
  ...
  },
  {
    ...
    "services": [
      {
        "name": "Decorator",
        "skills": ["Interior decorator", "Event decorator"],
        "category": "Decoration",
      },
    ],
  },
  ...
  {
    "name": "Childcare and Elderly Care",
    "services": [
      {
        "name": "Nanny",
        "skills": ["Elderly caregiver", "Maternity nurse"],
        "category": "Childcare and Elderly Care",
      },
    ],
  },
  {
    ...
    "services": [
      {
        ...
        "skills": ["Laptop repair", "Desktop repair"],
...
List<Map<String, dynamic>> statesJSON = [
  {
    "id": "66c4f6f27e06860a82685458",
    "name": "Lagos",
    "lgas": [
      "Agege",
      "Ajeromi-Ifelodun",
